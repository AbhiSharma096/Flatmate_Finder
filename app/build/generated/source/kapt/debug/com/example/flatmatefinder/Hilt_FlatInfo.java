 ...
 */
public abstract class Hilt_FlatInfo extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FlatInfo(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FlatInfo_GeneratedInjector) this.generatedComponent()).injectFlatInfo(UnsafeCasts.<FlatInfo>unsafeCast(this));
    }
  }
