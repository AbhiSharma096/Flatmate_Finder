 ...
 */
public abstract class Hilt_Gender extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Gender(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Gender_GeneratedInjector) this.generatedComponent()).injectGender(UnsafeCasts.<Gender>unsafeCast(this));
    }
  }
