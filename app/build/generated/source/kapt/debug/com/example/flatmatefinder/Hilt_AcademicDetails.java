 ...
 */
public abstract class Hilt_AcademicDetails extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AcademicDetails() {
    super();
  }

  Hilt_AcademicDetails(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AcademicDetails_GeneratedInjector) this.generatedComponent()).injectAcademicDetails(UnsafeCasts.<AcademicDetails>unsafeCast(this));
    }
  }
