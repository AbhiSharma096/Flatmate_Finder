 ...
 */
public abstract class Hilt_Name extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Name_GeneratedInjector) this.generatedComponent()).injectName(UnsafeCasts.<Name>unsafeCast(this));
    }
  }
