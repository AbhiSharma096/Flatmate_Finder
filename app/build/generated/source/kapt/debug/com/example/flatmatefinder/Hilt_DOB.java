 ...
 */
public abstract class Hilt_DOB extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DOB_GeneratedInjector) this.generatedComponent()).injectDOB(UnsafeCasts.<DOB>unsafeCast(this));
    }
  }
