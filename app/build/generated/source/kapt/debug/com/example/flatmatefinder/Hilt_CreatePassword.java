 ...
 */
public abstract class Hilt_CreatePassword extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreatePassword(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreatePassword_GeneratedInjector) this.generatedComponent()).injectCreatePassword(UnsafeCasts.<CreatePassword>unsafeCast(this));
    }
  }
