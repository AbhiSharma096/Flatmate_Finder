 ...
 */
public abstract class Hilt_Flat extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Flat_GeneratedInjector) this.generatedComponent()).injectFlat(UnsafeCasts.<Flat>unsafeCast(this));
    }
  }
