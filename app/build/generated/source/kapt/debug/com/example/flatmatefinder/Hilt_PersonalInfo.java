 ...
 */
public abstract class Hilt_PersonalInfo extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PersonalInfo(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PersonalInfo_GeneratedInjector) this.generatedComponent()).injectPersonalInfo(UnsafeCasts.<PersonalInfo>unsafeCast(this));
    }
  }
