 ...
 */
public abstract class Hilt_FlatInfo2 extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FlatInfo2(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FlatInfo2_GeneratedInjector) this.generatedComponent()).injectFlatInfo2(UnsafeCasts.<FlatInfo2>unsafeCast(this));
    }
  }
